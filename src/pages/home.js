      ...
      <div className="flex w-full h-full gap-4">     
        <div className='flex-col space-y-4'>
          <div className="flex bg-white border border-gray-200 shadow-xl rounded-xl p-4 w-full gap-3">
            ...
            <input type="text" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-red-500 focus:ring-red-500 disabled:opacity-50 disabled:pointer-events-nne" placeholder="Which do you think right now?"/>
          ...
          <div className="flex-col w-full gap-4 ">
            <div className="flex flex-col bg-white border border-gray-200 shadow-xl rounded-xl p-4 gap-2">    
              <div className='flex gap-2'>
                ...
                <span><a href='#user001'>
                  <h3 className="text-xl font-bold">User A</h3>
