...
function HomePage(){
  return(
    <div className="app">
      <div className="flex bg-white border border-gray-200 shadow-xl rounded-xl p-4 max-w-auto gap-3">
      ...
      <div className="flex-col w-full h-full grid grid-cols-3 justify-items-center gap-4">            
        ...
        <div className= "flex flex-col col-start-3 col-span-1 row-auto w-[350px]">
          ...
          <ul className="flex flex-col bg-white border border-gray-200 shadow-sm rounded-xl gap-4 pb-4">
            ...
            <li className="flex items-center gap-4 ml-4">
              <img className="size-[62px] rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="userAavatar"/>
              <div>
                <div className="text-lg font-bold"> User B</div>
                <div className="text-xs font-normal"> @User002</div>
              </div>
              <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                Follow
              </button>
            ...
            <li className="flex items-center gap-4 ml-4">
              <img className="size-[62px] rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="userAavatar"/>
              <div>
                <div className="text-lg font-bold"> User C</div>
                <div className="text-xs font-normal"> @User003</div>
              </div>
              <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                Follow
              </button>
            ...
            <li className="flex items-center gap-4 ml-4">
              <img className="size-[62px] rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="userAavatar"/>
              <div>
                <div className="text-lg font-bold"> User D</div>
                <div className="text-xs font-normal"> @User004</div>
              </div>
              <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                Follow
              </button>
